...
<div class='container mt-3 mb-2'>
    ...
    <form name ="crear" action="{{route('libros.store')}}" method="POST">
        ...
        <div class="row mt-3">
            ...
            <div class="col">
                <input type="text" class="form-control" placeholder="stock" min="0" step="1" name="stock">
            </div>
        </div>
        <div class="row mt-3">
            <div class="col">
        ...
        <div class="row mt-3">
            <div class = "col">
                ...
                <input type ="submit" class="ml-3 btn btn-info normal" value="Crear">
                <a href="{{route('libros.listado')}}" class="btn btn-success"> Volver </a>
            </div>
        </div>
    </form>
@endsection
