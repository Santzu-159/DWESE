...
<br><br>
    <?php
        if($_SESSION['usuario']['tipo']=='administrador'){
            ...
            echo "<a href='pagina3.php' class='btn btn-success'>Pagina 3</a>&nbsp;&nbsp;";
         
        }
        
        if($_SESSION['usuario']['tipo']=='administrador' || $_SESSION['usuario']['tipo']=='avanzado'){

            echo "<a href='pagina2.php' class='btn btn-success'>Pagina 2</a>&nbsp;"; // la pueden ver administrador y avanzado

        }

    ?>
    <a href='pagina1.php' class='btn btn-info'>Pagina 1</a> <!-- la pueden ver todos -->
